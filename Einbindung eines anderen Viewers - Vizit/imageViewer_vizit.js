    ...
    Template_imageViewer_vizit.prototype.init = function () {
        ...
        if (_this.ctx || _this.get_templateConfiguration().get_preventAutoload()) {
            ...
            this.ctx.getServerRelativeFileUrl().then(function(serverRelativeUrl) {
                ...
                try {
                    // Die Optionen beinhalten u.a. die Information darüber, worin der Viewer gerendert werden soll. Hier wird der für die Viewer vorgesehene Container ermittelt und das HTML-Element übergeben
                    ...
                    // Tritt beim Laden des Viewers ein Fehler auf, können ausführliche Informationen im Browser-Log oder als Notification ausgegeben werden
